...
import SectionProductFeaturesCrousel from './SectionProductFeaturesCrousel'
		...
		<div className="row">
			<div className="col-md-6 col-lg-6 col-xl-6">
				<div className="product-det">
					<img src="images/landing/product-peatures.png" className="img-fluid" alt=""/>
				</div>
			</div>
          ...
          <ul className="featureinfo detals-feat-info">
		  ...
		  <div className="shipping-section p-0 m-0 w-100">

          <SectionProductFeaturesCrousel/>
          <div className="discount-btns text-end pt-4"> <span>25%<br />
